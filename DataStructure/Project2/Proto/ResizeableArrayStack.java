    ...
    */
    ...
    public int evaluatePostfix(String pstFix)
    {
        ...
        */
        ...
        //if the walker is an operand call the caseOfOperand
        //else ignore the exception, and continue iterates
        while(pstFixTkn.hasNext()){
            //Case of integer
            if(pstFixTkn.hasNextInt()){
                variable = pstFixTkn.nextInt(); //Extract integer
                valStack.push(variable);
            }else{
                oprtr = pstFixTkn.next(); //Extract operator
                //Case of operator
                if (isOperator(oprtr)){
                    caseOfOperator(oprtr,valStack);
                }else{
                    //Ignore exception
                    continue;
                }
    ...
    /**
     ...
     @Param String walker token
     @Return boolean
     */
    public boolean isOperator(String wlkr){
     ...
     */
    public void caseOfOperator(String oprtr, ResizeableArrayStack<Integer> valStack)
    {
        /*
    ...
    /**
     ...
     @Param String operator, ResizeableArrayStack value stack
     */
    public void valCalculate(int oprnd1, int oprnd2, String oprtr, ResizeableArrayStack<Integer> valStack)
    {
        /*
        Get peek from valStack, Store peek to oprnd2 and PopValStack.
        Get peek from valStack, Store peek to oprnd1, and PopValStack
